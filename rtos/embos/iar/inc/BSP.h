...
#define LED1_ON GPIO_ResetBits(GPIOC, GPIO_Pin_6)
#define LED1_OFF GPIO_SetBits(GPIOC, GPIO_Pin_6)
#define LED1 (( GPIO_ReadOutputData( GPIOC ) & GPIO_Pin_6) == 0)
#define LED2_ON GPIO_ResetBits(GPIOC, GPIO_Pin_7)
#define LED2_OFF GPIO_SetBits(GPIOC, GPIO_Pin_7)
#define LED2 (( GPIO_ReadOutputData( GPIOC ) & GPIO_Pin_7) == 0 )
#define LED3_ON GPIO_ResetBits(GPIOC, GPIO_Pin_8)
#define LED3_OFF GPIO_SetBits(GPIOC, GPIO_Pin_8)
#define LED3 (( GPIO_ReadOutputData( GPIOC ) & GPIO_Pin_8) == 0 );
#define LED4_ON GPIO_ResetBits(GPIOC, GPIO_Pin_9)
#define LED4_OFF GPIO_SetBits(GPIOC, GPIO_Pin_9)
#define LED4 (( GPIO_ReadOutputData( GPIOC ) & GPIO_Pin_9) == 0)

#define HC05_CONF_OFF GPIO_ResetBits(GPIOC, GPIO_Pin_5)
#define HC05_CONF_ON GPIO_SetBits(GPIOC, GPIO_Pin_5)

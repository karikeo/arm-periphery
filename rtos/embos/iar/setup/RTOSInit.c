...
void OS_InitHW(void) {
  OS_U8  TickPrio;
  OS_U32 tmpreg;
  OS_SYSTIMER_CONFIG SysTimerConfig = {OS_PCLK_TIMER, OS_TICK_FREQ, 0, _OS_GetHWTimerCycles, _OS_GetHWTimer_IntPending}; // Setup values for OS_Config_SysTimer()
...
void HardFault_Handler(void) {
  ...
  if (NVIC_HFSR & (1uL << 31)) {
   ...
   const unsigned short KR_KEY_Enable = (unsigned short)0xCCCC;

...
/*********************************************************************
*
*     Chip specifics for Cortex M cores and Keil compiler
*
**********************************************************************
*/
...
*       Configuration
*/
#define OS_PORT_REVISION          (0u)                       // Port specific revision has to be defined as unsigned
...
#define OS_LeaveIntStack()                                   // No special stack switching required
    ...
    #define OS_BIG_ENDIAN         (1)
      ...
      #define OS_BIG_ENDIAN       (0)
    #else
      #error "Your compiler does not support __ARMEB__ or __ARMEL__."
    #endif
  #endif
#endif
...
#if defined __TARGET_ARCH_7E_M && defined __TARGET_FPU_VFP
...
// The extended stack frame is automatically reserved on exception entry.
// The FP registers are saved automatically when extended task context is used
...
void OS_Exception     (void);      // In RTOS.asm OS library w/o CMSIS
...
/*****  embOS stack check variables and functions *******************/
extern unsigned long OS_SysStackBaseAddr;
extern unsigned int  OS_SysStackSize;
extern unsigned long OS_SysStackLimit;
...
#define OS_VERSION_GENERIC (38803u)       /*  Generic version 3.88c */
